...
class XAdminiAcl
{
	...
	public static $aclList = array(
        ...
        '教师管理' => array(
            'controller'=>'teacher', 'url'=>'teacher/index', 'acl'=>'user','action'=>array(
                array('name'=>'教师列表','url'=>'teacher/index','acl'=>'teacher_index','list_acl'=>array(
                    '录入'=>'teacher_create', '编辑'=>'teacher_update', '删除'=>'teacher_delete'
                )),
            )
        ),
        '学生管理' => array(
            'controller'=>'student', 'url'=>'student/index', 'acl'=>'user','action'=>array(
                array('name'=>'学生列表','url'=>'student/index','acl'=>'student_index','list_acl'=>array(
                    '录入'=>'student_create', '编辑'=>'student_update', '删除'=>'student_delete'
                )),
            )
        ),
        '家长管理' => array(
            'controller'=>'parent', 'url'=>'parent/index', 'acl'=>'user','action'=>array(
                array('name'=>'家长列表','url'=>'parent/index','acl'=>'parent_index','list_acl'=>array(
                    '录入'=>'parent_create', '编辑'=>'parent_update', '删除'=>'parent_delete'
                )),
            )
        ),
        '课外活动' => array(
        ...
        '留学圈' => array(
            'controller'=>'studyAbroad', 'url'=>'question/index', 'acl'=>'user','action'=>array(
                array('name'=>'留学圈','url'=>'question/index','acl'=>'question_index','list_acl'=>array(
